...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NavBarEntry.new_window'
        db.add_column('navbar_navbarentry', 'new_window',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NavBarEntry.new_window'
        db.delete_column('navbar_navbarentry', 'new_window')
    ...
    models = {
        ...
        'navbar.navbarentry': {
            'Meta': {'ordering': "('parent__id', 'order')", 'object_name': 'NavBarEntry'},
